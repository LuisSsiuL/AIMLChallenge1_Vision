...
STATIC_STUCK_DIFF_THRESHOLD       = 20.0 # mean abs pixel diff below this counts as "no change"
...
class Navigator:
    ...
    def process_frame(self, depth_u8: np.ndarray) -> tuple:
        ...
        if must_reverse_now:
            ...
            elif self._consecutive_reverse > REVERSE_ESCAPE_FRAMES:
                raw_cmd = (
                    DrivingCommand.REVERSE_LEFT
